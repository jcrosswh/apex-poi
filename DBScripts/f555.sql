...
prompt  APPLICATION 555 - POI Demo App
--
-- Application Export:
--   Application:     555
--   Name:            POI Demo App
--   Date and Time:   14:50 Wednesday February 10, 2016
--   Exported By:     ADMIN
--   Flashback:       0
...
begin
  ...
  wwv_flow_api.set_security_group_id(p_security_group_id=>nvl(wwv_flow_application_install.get_workspace_id,2224912942262033));
...
begin
   ...
   -- SET APPLICATION ID
   wwv_flow.g_flow_id := nvl(wwv_flow_application_install.get_application_id,555);
...
begin
   ...
   -- Remove Application
wwv_flow_api.remove_flow(nvl(wwv_flow_application_install.get_application_id,555));
...
wwv_flow_audit.remove_audit_trail(nvl(wwv_flow_application_install.get_application_id,555));
null;
...
wwv_flow_api.create_flow(
  p_id    => nvl(wwv_flow_application_install.get_application_id,555),
  p_display_id=> nvl(wwv_flow_application_install.get_application_id,555),
  p_owner => nvl(wwv_flow_application_install.get_schema,'C##POI_DEMO'),
  p_name  => nvl(wwv_flow_application_install.get_application_name,'POI Demo App'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'F_555'),
  p_page_view_logging => 'YES',
  p_page_protection_enabled_y_n=> 'Y',
  p_checksum_salt=> 'A96FB405981E1186CFD15C415FA110F44AB9FC3AFA56AE6152BA0E9AD3746F66',
  ...
  p_authentication_id=> 2386419784072088 + wwv_flow_api.g_id_offset,
  p_logout_url=> '',
  p_application_tab_set=> 0,
  p_logo_image => 'TEXT:POI Demo App',
  p_public_url_prefix => '',
  p_public_user=> '',
  p_dbauth_url_prefix => '',
  ...
  p_last_upd_yyyymmddhh24miss=> '20160210081829',
  p_ui_type_name => null,
...
wwv_flow_api.create_user_interface (
  p_id => 2386227776072080 + wwv_flow_api.g_id_offset
...
wwv_flow_api.create_plugin_setting (
  p_id => 2375327288072049 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
wwv_flow_api.create_icon_bar_item(
  p_id => 2386306276072086 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_icon_sequence=> 200,
  p_icon_image => '',
...
wwv_flow_api.create_tab (
  p_id=> 2387824722072098 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 10,
  p_tab_name=> 'T_HOME',
...
wwv_flow_api.create_list_of_values (
  p_id       => 2395529042083226 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'DATA_LOAD_CHARSET',
  p_lov_query=> '.'||to_char(2395529042083226 + wwv_flow_api.g_id_offset)||'.');
...
wwv_flow_api.create_static_lov_data (
  p_id=>2395803803083228 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2396118811083229 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2396414237083229 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2396726529083229 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2397006040083229 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2397330047083229 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2397609310083229 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2397914292083229 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2398212111083229 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2398505999083229 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2398824795083229 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2399115903083231 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2399429752083231 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2399708439083231 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2400003922083231 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2400314951083231 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2400609731083231 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2400905245083231 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2401219671083231 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2401505829083231 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2401801764083232 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2402127078083232 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2402417284083232 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2402714891083232 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2403015339083232 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2403318456083232 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2403632243083232 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2403902885083232 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2404200151083232 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2404523234083232 + wwv_flow_api.g_id_offset,
  p_lov_id=>2395529042083226 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_list_of_values (
  p_id       => 2391811460083215 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'DATA_LOAD_OPTION',
  p_lov_query=> '.'||to_char(2391811460083215 + wwv_flow_api.g_id_offset)||'.');
...
wwv_flow_api.create_static_lov_data (
  p_id=>2392116269083218 + wwv_flow_api.g_id_offset,
  p_lov_id=>2391811460083215 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2392404924083220 + wwv_flow_api.g_id_offset,
  p_lov_id=>2391811460083215 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_list_of_values (
  p_id       => 2394515355083224 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'FIRST_ROW_OPTION',
  p_lov_query=> '.'||to_char(2394515355083224 + wwv_flow_api.g_id_offset)||'.');
...
wwv_flow_api.create_static_lov_data (
  p_id=>2394823017083226 + wwv_flow_api.g_id_offset,
  p_lov_id=>2394515355083224 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>10,
...
wwv_flow_api.create_page (
  p_flow_id => wwv_flow.g_flow_id
 ,p_id => 1
 ,p_user_interface_id => 2386227776072080 + wwv_flow_api.g_id_offset
 ,p_tab_set => 'TS1'
 ,p_name => 'Home'
 ,p_step_title => 'Home'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20160209201656'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 2388011083072100 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
  p_escape_on_http_output=>'N',
  p_plug_template=> 2377818975072059+ wwv_flow_api.g_id_offset,
  ...
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(2387504688072095 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 2385532337072070+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2430225441190341 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Welcome to the POI demo app',
  p_region_name=>'',
  p_escape_on_http_output=>'Y',
  p_plug_template=> 2379806844072063+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 2430422455198994 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 1,
  p_button_sequence=> 10,
  p_button_plug_id => 2430225441190341+wwv_flow_api.g_id_offset,
  p_button_name    => 'LOAD_DATA',
  p_button_action  => 'REDIRECT_PAGE',
  p_button_image   => 'template:'||to_char(2384509318072070+wwv_flow_api.g_id_offset),
  p_button_is_hot=>'N',
...
prompt  ...PAGE 10: Data Load Source
--
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20160209201956'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2391111839083210 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 10,
  ...
  p_plug_item_display_point=> 'ABOVE',
  p_plug_source=> s,
  p_plug_source_type=> 2389119429083204 + wwv_flow_api.g_id_offset,
  p_list_template_id=> 2383815936072067+ wwv_flow_api.g_id_offset,
  p_translate_title=> 'N',
  p_plug_query_row_template=> 1,
  p_plug_query_headings_type=> 'COLON_DELMITED_LIST',
  p_plug_query_row_count_max => 500,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2391229575083210 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 10,
  ...
  p_escape_on_http_output=>'N',
  p_plug_template=> 2380631881072063+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 20,
  p_plug_new_grid         => false,
  p_plug_new_grid_row     => true,
  p_plug_new_grid_column  => true,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2405613795083235 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 10,
...
wwv_flow_api.create_page_button(
  p_id             => 2391501890083214 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 10,
  p_button_sequence=> 10,
  p_button_plug_id => 2391229575083210+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 2391603572083214 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 10,
  ...
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'javascript:apex.widget.textareaClob.upload(''P10_COPY_PASTE'', ''NEXT'');',
  p_button_execute_validations=>'Y',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_branch(
  p_id=>2408829375083242 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
  p_branch_name=> '',
  ...
  p_branch_when_button_id=>2391603572083214+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_item(
  p_id=>2392709049083220 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
  ...
  p_item_sequence=> 10,
  p_item_plug_id => 2391229575083210+wwv_flow_api.g_id_offset,
  ...
  p_lov=> '.'||to_char(2391811460083215 + wwv_flow_api.g_id_offset)||'.',
  ...
  p_field_template=> 2384102926072069+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
...
wwv_flow_api.create_page_item(
  p_id=>2392816540083220 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
  ...
  p_field_alignment=> 'LEFT',
  p_field_template=> 2384417179072069+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_protection_level => 'N',
  p_escape_on_http_input => 'Y',
  p_escape_on_http_output => 'Y',
...
wwv_flow_api.create_page_item(
  p_id=>2393608533083223 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
...
wwv_flow_api.create_page_item(
  p_id=>2394107192083223 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
...
begin
h := null;
h:=h||'Select this box if your data contains column names in the first row.';

wwv_flow_api.create_page_item(
  p_id=>2395113660083226 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
  ...
  p_lov=> '.'||to_char(2394515355083224 + wwv_flow_api.g_id_offset)||'.',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 30,
  p_cMaxlength=> null,
...
begin
h := null;
h:=h||'DATA_LOAD.CHAR_SET_ITEM_HELP';

wwv_flow_api.create_page_item(
  p_id=>2404828654083235 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
  p_name=>'P10_CHAR_SET',
  p_data_type=> 'VARCHAR',
  ...
  p_lov=> '.'||to_char(2395529042083226 + wwv_flow_api.g_id_offset)||'.',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 30,
  p_cMaxlength=> 2000,
...
begin
wwv_flow_api.create_page_item(
  p_id=>2405325650083235 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
  p_name=>'P10_STOP_START_TABLE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 60,
...
begin
wwv_flow_api.create_page_item(
  p_id=>2405416811083235 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
...
wwv_flow_api.create_page_item(
  p_id=>2405907062083237 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
  p_name=>'P10_CURRENCY',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 2405613795083235+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default=> '$',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
...
wwv_flow_api.create_page_item(
  p_id=>2406411639083237 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
...
wwv_flow_api.create_page_item(
  p_id=>2406929000083239 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
...
wwv_flow_api.create_page_validation(
  p_id => 2393411499083221 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 10,
  ...
  p_when_button_pressed=> 2391603572083214 + wwv_flow_api.g_id_offset,
  p_associated_item=> 2392816540083220 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_da_event (
  p_id => 2407302039083239 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_page_id => 10
...
wwv_flow_api.create_page_da_action (
  p_id => 2407606720083240 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_page_id => 10
 ,p_event_id => 2407302039083239 + wwv_flow_api.g_id_offset
 ,p_event_result => 'TRUE'
...
wwv_flow_api.create_page_da_action (
  p_id => 2407813852083240 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_page_id => 10
 ,p_event_id => 2407302039083239 + wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_da_event (
  p_id => 2407927345083240 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_page_id => 10
...
wwv_flow_api.create_page_da_action (
  p_id => 2408230499083242 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_page_id => 10
 ,p_event_id => 2407927345083240 + wwv_flow_api.g_id_offset
 ,p_event_result => 'TRUE'
 ,p_action_sequence => 10
 ,p_execute_on_page_init => 'Y'
 ,p_action => 'NATIVE_SHOW'
...
wwv_flow_api.create_page_da_action (
  p_id => 2408423738083242 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_page_id => 10
 ,p_event_id => 2407927345083240 + wwv_flow_api.g_id_offset
 ,p_event_result => 'FALSE'
...
wwv_flow_api.create_page_process(
  p_id     => 2408603618083242 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 10,
  ...
  p_attribute_01=> 2388914650083198 + wwv_flow_api.g_id_offset,
  ...
  p_process_when_button_id=>2391603572083214 + wwv_flow_api.g_id_offset,
  p_process_when=>'',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'delete emp;'||unistr('\000a')||
'delete dept;'||unistr('\000a')||
''||unistr('\000a')||
''||unistr('\000a')||
'POI_DEMO.ADD_HEAD_TO_COL('||unistr('\000a')||
'      p_C001 => ''EMPNO'','||unistr('\000a')||
'      p_C002 => ''ENAME'','||unistr('\000a')||
'      p_C003 => ''JOB'','||unistr('\000a')||
'      p_C004 => ''MGR'','||unistr('\000a')||
'      p_C005 => ''HIREDATE'','||unistr('\000a')||
'      p_C006 => ''SAL'','||unistr('\000a')||
'      p_C007 => ''COMM'','||unistr('\000a')||
'      p_C008 => ''DEPTNO'');'||unistr('\000a')||
''||unistr('\000a')||
''||unistr('\000a')||
'DECLARE'||unistr('\000a')||
'   l_file_id   wwv_flow_files.id%TYPE;'||unistr('\000a')||
'BEGIN'||unistr('\000a')||
'   SELECT id'||unistr('\000a')||
'     INTO l_file_id'||unistr('\000a')||
'     FROM wwv_flow_files'||unistr('\000a')||
'    WHERE name = :P10_FILE_NAME;'||unistr('\000a')||
''||unistr('\000a')||
'  ';

p:=p||' J_LOAD_POI_DEMO_FILE (p_apex_username => :APP_USER, p_apex_session_id => :SESSION, P_UPLOAD_FILE_ID => l_file_id);'||unistr('\000a')||
'END;';

wwv_flow_api.create_page_process(
  p_id     => 2446528857185085 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 10,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'PLSQL',
  p_process_name=> 'Clear data and populate header information',
  p_process_sql_clob => p,
  p_process_error_message=> '',
  p_error_display_location=> 'INLINE_IN_NOTIFICATION',
  p_process_when_button_id=>2391603572083214 + wwv_flow_api.g_id_offset,
...
prompt  ...PAGE 15: DEPT data validation
--
...
wwv_flow_api.create_page (
 ...
 ,p_user_interface_id => 2386227776072080 + wwv_flow_api.g_id_offset
 ,p_tab_set => 'TS1'
 ,p_name => 'DEPT data validation'
 ,p_step_title => 'DEPT Data Review'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title => 'DEPT data validation'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
...
wwv_flow_api.create_report_region (
  p_id=> 2433104516673912 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 15,
  p_name=> 'DEPT Data Review',
  p_region_name=>'',
  p_template=> 2379806844072063+ wwv_flow_api.g_id_offset,
  ...
  p_translate_title=> 'Y',
  p_ajax_enabled=> 'Y',
  p_query_row_template=> 2381516601072066+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_report_columns (
  p_id=> 2433406899673917 + wwv_flow_api.g_id_offset,
  p_region_id=> 2433104516673912 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2433506738673917 + wwv_flow_api.g_id_offset,
  p_region_id=> 2433104516673912 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2433623420673917 + wwv_flow_api.g_id_offset,
  p_region_id=> 2433104516673912 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2433903671677396 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 15,
  p_plug_name=> 'Data Load Process Train',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 2439019041690525 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 15,
  p_button_sequence=> 10,
  p_button_plug_id => 2433104516673912+wwv_flow_api.g_id_offset,
  p_button_name    => 'CANCEL',
  p_button_action  => 'REDIRECT_PAGE',
  p_button_image   => 'template:'||to_char(2384509318072070+wwv_flow_api.g_id_offset),
  p_button_is_hot=>'N',
...
wwv_flow_api.create_page_button(
  p_id             => 2439415760690527 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 15,
...
wwv_flow_api.create_page_button(
  p_id             => 2439210880690525 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 15,
  p_button_sequence=> 20,
  p_button_plug_id => 2433104516673912+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>2440203358698837 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 15,
  p_branch_name=> 'Branch to page 20',
  p_branch_action=> 'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>2439415760690527+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 10,
  p_save_state_before_branch_yn=>'N',
  p_branch_comment=> '');
...
prompt  ...PAGE 20: Data / Table Mapping
--
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20160207141937'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2409400509083243 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 20,
  p_plug_name=> 'Data Load Process Train',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2409501332083243 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 20,
...
wwv_flow_api.create_page_button(
  p_id             => 2409821988083245 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 20,
  p_button_sequence=> 10,
  p_button_plug_id => 2409501332083243+wwv_flow_api.g_id_offset,
  p_button_name    => 'CANCEL',
  p_button_action  => 'REDIRECT_PAGE',
  p_button_image   => 'template:'||to_char(2384509318072070+wwv_flow_api.g_id_offset),
  p_button_is_hot=>'N',
...
wwv_flow_api.create_page_button(
  p_id             => 2410112396083245 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 20,
  p_button_sequence=> 30,
  p_button_plug_id => 2409501332083243+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 2410026121083245 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 20,
  p_button_sequence=> 20,
  p_button_plug_id => 2409501332083243+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>2410621292083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 20,
  p_branch_name=> '',
  ...
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>2410112396083245+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 10,
  p_save_state_before_branch_yn=>'N',
  p_branch_comment=> '');
...
p := null;
wwv_flow_api.create_page_process(
  p_id     => 2410424968083245 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 20,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_error_message=> '',
  p_error_display_location=> 'INLINE_IN_NOTIFICATION',
  p_process_when_button_id=>2410112396083245 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
prompt  ...PAGE 30: EMP Data Validation
--
...
wwv_flow_api.create_page (
 ...
 ,p_user_interface_id => 2386227776072080 + wwv_flow_api.g_id_offset
 ,p_tab_set => 'TS1'
 ,p_name => 'EMP Data Validation'
 ,p_step_title => 'EMP Data Validation'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'NO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20160209181232'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2411232294083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 30,
  p_plug_name=> 'Data Load Process Train',
  p_region_name=>'',
...
wwv_flow_api.create_report_region (
  p_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 30,
  p_name=> 'Data Validation',
  p_region_name=>'',
  p_template=> 2380631881072063+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2411613075083254 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2411715183083254 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2411830991083254 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2411902427083254 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2412003982083254 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2412114526083254 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2412219293083254 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2412310921083254 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2412419969083254 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 9,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2412521648083254 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2412625729083254 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2412731352083254 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2412824452083254 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2412928324083254 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2413032027083254 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2413112268083254 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2413208662083254 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2413330563083254 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2413423020083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2413502556083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2413615519083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2413701322083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2413809005083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2413928073083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2414000484083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2414105627083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2414225906083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2414303648083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2414428107083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2414518789083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2414630272083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2414703051083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2414808593083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2414907857083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2415015787083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2415113438083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2415230153083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2415300846083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2415406195083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2415521121083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2415632727083256 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2415715743083257 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2415821921083257 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2415913945083257 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2416009900083257 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2416132579083257 + wwv_flow_api.g_id_offset,
  p_region_id=> 2411306085083246 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
wwv_flow_api.create_page_button(
  p_id             => 2416326236083257 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 30,
  p_button_sequence=> 10,
  p_button_plug_id => 2411306085083246+wwv_flow_api.g_id_offset,
  p_button_name    => 'CANCEL',
  p_button_action  => 'REDIRECT_PAGE',
  p_button_image   => 'template:'||to_char(2384509318072070+wwv_flow_api.g_id_offset),
  p_button_is_hot=>'N',
...
wwv_flow_api.create_page_button(
  p_id             => 2416614803083257 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 30,
  p_button_sequence=> 30,
  p_button_plug_id => 2411306085083246+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 2416511653083257 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 30,
  p_button_sequence=> 20,
  p_button_plug_id => 2411306085083246+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>2417106067083259 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30,
  p_branch_name=> '',
  ...
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>2416614803083257+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 10,
  p_save_state_before_branch_yn=>'N',
  p_branch_comment=> '');
...
p := null;
wwv_flow_api.create_page_process(
  p_id     => 2416910117083257 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 30,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p,
  p_attribute_01=> 2388914650083198 + wwv_flow_api.g_id_offset,
  p_attribute_02=> 'P40_INSERT_COUNT',
  p_attribute_03=> 'P40_UPDATE_COUNT',
  p_attribute_04=> 'P40_ERROR_COUNT',
  p_attribute_05=> 'P40_REVIEW_COUNT',
  p_process_error_message=> 'Data Loading Failed',
  p_error_display_location=> 'INLINE_IN_NOTIFICATION',
  p_process_when_button_id=>2416614803083257 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
prompt  ...PAGE 40: Data Load Results
--
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20160209191944'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2417711705083259 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 40,
  p_plug_name=> 'Data Load Process Train',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2417820909083259 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 40,
...
wwv_flow_api.create_report_region (
  p_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 40,
  ...
  p_source=> s,
  p_source_type=> 'SQL_QUERY',
  p_display_when_condition=> 'P40_ERROR_COUNT',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2419505659083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'ROW_NUM',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2419604554083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2419724105083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2419801470083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2419926310083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2420009018083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2420115061083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2420220275083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2420319058083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 9,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2420400900083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 10,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2420505641083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 11,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2420616681083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 12,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2420707632083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 13,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2420814462083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 14,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2420927032083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 15,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2421006649083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 16,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2421109520083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 17,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2421222236083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 18,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2421329649083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 19,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2421401229083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 20,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2421520809083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 21,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2421626723083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 22,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2421710725083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 23,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2421812792083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 24,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2421921061083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 25,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2422001388083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 26,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2422118076083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 27,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2422218582083263 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 28,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2422309488083265 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 29,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2422415771083265 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 30,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2422516696083265 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 31,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2422628005083265 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 32,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2422701762083265 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 33,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2422811233083265 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 34,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2422914505083265 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 35,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2423023266083265 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 36,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2423131499083265 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 37,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2423220912083265 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 38,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2423307924083265 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 39,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2423418087083265 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 40,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2423520223083265 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 41,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2423605502083265 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 42,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2423712509083265 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 43,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2423804100083265 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 44,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2423918593083265 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 45,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2424000125083265 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 46,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2424101500083265 + wwv_flow_api.g_id_offset,
  p_region_id=> 2419218743083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
wwv_flow_api.create_report_region (
  p_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 40,
  ...
  p_source=> s,
  p_source_type=> 'SQL_QUERY',
  p_display_when_condition=> 'P40_REVIEW_COUNT',
  p_display_condition_type=> 'ITEM_NOT_NULL_OR_ZERO',
  p_plug_caching=> 'NOT_CACHED',
  p_query_row_template=> 1,
  p_query_headings=> 'declare  '||unistr('\000a')||
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2424517471083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'ROW_NUM',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2424616836083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2424731808083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2424827569083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2424917820083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2425020055083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2425115457083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2425215642083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2425314202083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 9,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2425407899083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 10,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2425529399083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 11,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2425620050083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 12,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2425701087083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 13,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2425802585083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 14,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2425917641083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 15,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2426016897083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 16,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2426104188083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 17,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2426219065083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 18,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2426332090083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 19,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2426408245083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 20,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2426506072083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 21,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2426615709083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 22,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2426712913083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 23,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2426824287083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 24,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2426914171083268 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 25,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2427019393083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 26,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2427130275083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 27,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2427202441083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 28,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2427328508083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 29,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2427414352083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 30,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2427532068083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 31,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2427625690083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 32,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2427710509083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 33,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2427819785083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 34,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2427926381083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 35,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2428009804083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 36,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2428103428083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 37,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2428211090083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 38,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2428305488083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 39,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2428409899083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 40,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2428514253083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 41,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2428611420083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 42,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2428715802083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 43,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2428806610083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 44,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2428904206083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 45,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2429008441083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 46,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2429108263083270 + wwv_flow_api.g_id_offset,
  p_region_id=> 2424229661083265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 47,
  p_form_element_id=> null,
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select EMP.EMPNO as EMPNO,'||unistr('\000a')||
'    EMP.ENAME as ENAME,'||unistr('\000a')||
'    EMP.JOB as JOB,'||unistr('\000a')||
'    EMP.MGR as MGR,'||unistr('\000a')||
'    EMP.HIREDATE as HIREDATE,'||unistr('\000a')||
'    EMP.SAL as SAL,'||unistr('\000a')||
'    EMP.COMM as COMM,'||unistr('\000a')||
'    EMP.DEPTNO as DEPTNO '||unistr('\000a')||
' from EMP EMP';

wwv_flow_api.create_report_region (
  p_id=> 2481714546322879 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 40,
  p_name=> 'EMP',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2482005353322883 + wwv_flow_api.g_id_offset,
  p_region_id=> 2481714546322879 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2482116899322883 + wwv_flow_api.g_id_offset,
  p_region_id=> 2481714546322879 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2482223177322883 + wwv_flow_api.g_id_offset,
  p_region_id=> 2481714546322879 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2482307720322883 + wwv_flow_api.g_id_offset,
  p_region_id=> 2481714546322879 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2482415450322883 + wwv_flow_api.g_id_offset,
  p_region_id=> 2481714546322879 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2482511955322883 + wwv_flow_api.g_id_offset,
  p_region_id=> 2481714546322879 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2482622414322883 + wwv_flow_api.g_id_offset,
  p_region_id=> 2481714546322879 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2482702871322883 + wwv_flow_api.g_id_offset,
  p_region_id=> 2481714546322879 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
...
wwv_flow_api.create_page_button(
  p_id             => 2418104713083259 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 40,
  p_button_sequence=> 10,
  p_button_plug_id => 2417820909083259+wwv_flow_api.g_id_offset,
  p_button_name    => 'CANCEL',
  p_button_action  => 'REDIRECT_PAGE',
  p_button_image   => 'template:'||to_char(2384509318072070+wwv_flow_api.g_id_offset),
  p_button_is_hot=>'N',
...
wwv_flow_api.create_page_button(
  p_id             => 2418202861083259 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 40,
  p_button_sequence=> 30,
  p_button_plug_id => 2417820909083259+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>2418517513083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 40,
  p_name=>'P40_INSERT_COUNT',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 2417820909083259+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
...
begin
wwv_flow_api.create_page_item(
  p_id=>2418710242083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 40,
  p_name=>'P40_UPDATE_COUNT',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 20,
...
begin
wwv_flow_api.create_page_item(
  p_id=>2418901723083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 40,
  p_name=>'P40_ERROR_COUNT',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 30,
...
begin
wwv_flow_api.create_page_item(
  p_id=>2419100206083260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 40,
  p_name=>'P40_REVIEW_COUNT',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 40,
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 2375409321072050 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_last_upd_yyyymmddhh24miss => '20160207141745'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2386723421072092 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
  p_escape_on_http_output=>'N',
  p_plug_template=> 2378501950072061+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_new_grid         => false,
  p_plug_new_grid_row     => true,
  p_plug_new_grid_column  => true,
...
begin
wwv_flow_api.create_page_item(
  p_id=>2386812241072094 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 2386723421072092+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>2386928384072095 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>2387011272072095 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => 'template:'||to_char(2384509318072070 + wwv_flow_api.g_id_offset),
  p_new_grid=> false,
  p_begin_on_new_line=> 'NO',
  p_begin_on_new_field=> 'YES',
  p_colspan=> null,
...
wwv_flow_api.create_page_process(
  p_id     => 2387231476072095 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 2387131558072095 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 2387419729072095 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 2387325343072095 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
prompt  ...lists
--
--application/shared_components/navigation/lists/data_load_process_train_emp
 
begin
 
wwv_flow_api.create_list (
  p_id=> 2389119429083204 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Data Load Process Train - EMP',
  p_list_type=> 'STATIC',
  p_list_query=>'',
...
wwv_flow_api.create_list_item (
  p_id=> 2389523580083206 + wwv_flow_api.g_id_offset,
  p_list_id=> 2389119429083204 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_list_item (
  p_id=> 2430916743234488 + wwv_flow_api.g_id_offset,
  p_list_id=> 2389119429083204 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>15,
  p_list_item_link_text=> 'DEPT Data Review',
...
wwv_flow_api.create_list_item (
  p_id=> 2389823029083207 + wwv_flow_api.g_id_offset,
  p_list_id=> 2389119429083204 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 2390112694083207 + wwv_flow_api.g_id_offset,
  p_list_id=> 2389119429083204 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 2390429881083207 + wwv_flow_api.g_id_offset,
  p_list_id=> 2389119429083204 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
--application/shared_components/navigation/lists/data_load_process_train_emp2
 
begin
 
wwv_flow_api.create_list (
  p_id=> 2448423376209537 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Data Load Process Train - emp2',
  p_list_type=> 'STATIC',
  p_list_query=>'',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT' );
...
wwv_flow_api.create_menu (
  p_id=> 2387504688072095 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> ' Breadcrumb');
 
wwv_flow_api.create_menu_option (
  p_id=>2387912397072100 + wwv_flow_api.g_id_offset,
  p_menu_id=>2387504688072095 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
...
prompt  ...page templates for application: 555
--
--application/shared_components/user_interface/templates/page/login
prompt  ......Page template 2375409321072050
 
begin
 
wwv_flow_api.create_template (
  p_id => 2375409321072050 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
 ,p_name => 'Login'
 ,p_is_popup => false
...
prompt  ......Page template 2375520231072053
 
begin
 
wwv_flow_api.create_template (
  p_id => 2375520231072053 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
 ,p_name => 'Minimal Page'
 ,p_is_popup => false
...
prompt  ......Page template 2375623480072053
 
begin
 
wwv_flow_api.create_template (
  p_id => 2375623480072053 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 2375707409072055
 
begin
 
wwv_flow_api.create_template (
  p_id => 2375707409072055 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 2375808489072055
 
begin
 
wwv_flow_api.create_template (
  p_id => 2375808489072055 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 2375908763072055
 
begin
 
wwv_flow_api.create_template (
  p_id => 2375908763072055 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 2376000055072055
 
begin
 
wwv_flow_api.create_template (
  p_id => 2376000055072055 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 2376132333072055
 
begin
 
wwv_flow_api.create_template (
  p_id => 2376132333072055 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 2376206890072055
 
begin
 
wwv_flow_api.create_template (
  p_id => 2376206890072055 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 2376319881072055
 
begin
 
wwv_flow_api.create_template (
  p_id => 2376319881072055 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 2376407548072056
 
begin
 
wwv_flow_api.create_template (
  p_id => 2376407548072056 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 2376520522072056
 
begin
 
wwv_flow_api.create_template (
  p_id => 2376520522072056 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 2376630941072056
 
begin
 
wwv_flow_api.create_template (
  p_id => 2376630941072056 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 2376722561072056
 
begin
 
wwv_flow_api.create_template (
  p_id => 2376722561072056 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
 ,p_name => 'Popup'
 ,p_is_popup => false
...
prompt  ......Page template 2376827716072056
 
begin
 
wwv_flow_api.create_template (
  p_id => 2376827716072056 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 2376917920072056
 
begin
 
wwv_flow_api.create_template (
  p_id => 2376917920072056 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 2377011341072056
 
begin
 
wwv_flow_api.create_template (
  p_id => 2377011341072056 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 2377124417072056
 
begin
 
wwv_flow_api.create_template (
  p_id => 2377124417072056 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 2377219028072056
 
begin
 
wwv_flow_api.create_template (
  p_id => 2377219028072056 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Button Template 2384509318072070
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 2384509318072070 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 2384628259072070
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 2384628259072070 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 2384731629072070
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 2384731629072070 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 2384806637072070
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 2384806637072070 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 2384905077072070
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 2384905077072070 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 2385006464072070
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 2385006464072070 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 2385106573072070
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 2385106573072070 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 2385215134072070
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 2385215134072070 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 2385308649072070
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 2385308649072070 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 2385400860072070
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 2385400860072070 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......region template 2377316764072058
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2377316764072058 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2377428941072059
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2377428941072059 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2377522131072059
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2377522131072059 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2377611142072059
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2377611142072059 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2377725084072059
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2377725084072059 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2377818975072059
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2377818975072059 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2377915689072061
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2377915689072061 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2378009490072061
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2378009490072061 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2378100843072061
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2378100843072061 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2378201702072061
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2378201702072061 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2378303480072061
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2378303480072061 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2378432543072061
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2378432543072061 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2378501950072061
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2378501950072061 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2378623309072061
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2378623309072061 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2378722770072061
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2378722770072061 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2378830858072061
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2378830858072061 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion uBorderlessRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2378902254072061
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2378902254072061 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2379023161072063
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2379023161072063 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2379121543072063
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2379121543072063 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2379210486072063
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2379210486072063 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2379319672072063
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2379319672072063 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2379423661072063
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2379423661072063 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2379519421072063
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2379519421072063 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2379611540072063
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2379611540072063 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2379706546072063
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2379706546072063 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2379806844072063
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2379806844072063 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2379915981072063
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2379915981072063 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2380002356072063
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2380002356072063 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2380117328072063
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2380117328072063 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2380205045072063
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2380205045072063 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2380305889072063
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2380305889072063 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2380428173072063
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2380428173072063 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2380505367072063
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2380505367072063 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 2380631881072063
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2380631881072063 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2380717900072063
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2380717900072063 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 2380819401072063
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2380819401072063 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......list template 2382025295072066
...
wwv_flow_api.create_list_template (
  p_id=>2382025295072066 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
...
prompt  ......list template 2382101348072067
...
wwv_flow_api.create_list_template (
  p_id=>2382101348072067 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2382225752072067
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2382225752072067 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2382310651072067
...
wwv_flow_api.create_list_template (
  p_id=>2382310651072067 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2382409091072067
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2382409091072067 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2382519666072067
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2382519666072067 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2382615681072067
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2382615681072067 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2382706328072067
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2382706328072067 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2382828133072067
...
wwv_flow_api.create_list_template (
  p_id=>2382828133072067 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2382928561072067
...
wwv_flow_api.create_list_template (
  p_id=>2382928561072067 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2383007424072067
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2383007424072067 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2383113905072067
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2383113905072067 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2383201240072067
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2383201240072067 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2383312908072067
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2383312908072067 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2383427171072067
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2383427171072067 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2383504600072067
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2383504600072067 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2383628420072067
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2383628420072067 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2383726181072067
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2383726181072067 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2383815936072067
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2383815936072067 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......report template 2380926048072064
...
wwv_flow_api.create_row_template (
  p_id=> 2380926048072064 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2381020480072064
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2381020480072064 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2381112874072064
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2381112874072064 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2381224404072066
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2381224404072066 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2381301455072066
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2381301455072066 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2381417756072066
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2381417756072066 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2381516601072066
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2381516601072066 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2381609702072066
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2381609702072066 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2381720405072066
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2381720405072066 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2381815245072066
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2381815245072066 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2381927670072066
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2381927670072066 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 2383916459072069
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 2383916459072069 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 2384011237072069
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 2384011237072069 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 2384102926072069
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 2384102926072069 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 2384201758072069
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 2384201758072069 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 2384301679072069
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 2384301679072069 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 2384417179072069
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 2384417179072069 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 2385532337072070
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 2385532337072070 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 2385631989072072
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 2385631989072072 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--
prompt  ......template 2386012679072074
 
begin
 
begin
wwv_flow_api.create_popup_lov_template (
  p_id=> 2386012679072074 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 2385701075072072
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 2385701075072072 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 2385802495072074
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 2385802495072074 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 2385921109072074
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 2385921109072074 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......theme 2386101693072078
begin
wwv_flow_api.create_theme (
  p_id =>2386101693072078 + wwv_flow_api.g_id_offset,
  p_flow_id =>wwv_flow.g_flow_id,
  p_theme_id  => 26,
  p_theme_name=>'Productivity Applications',
  p_ui_type_name=>'DESKTOP',
  p_is_locked=>false,
  p_default_page_template=>2376319881072055 + wwv_flow_api.g_id_offset,
  p_error_template=>2375808489072055 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=>2376827716072056 + wwv_flow_api.g_id_offset,
  p_breadcrumb_display_point=>'REGION_POSITION_01',
  p_sidebar_display_point=>'REGION_POSITION_02',
  p_login_template=>2375409321072050 + wwv_flow_api.g_id_offset,
  p_default_button_template=>2384509318072070 + wwv_flow_api.g_id_offset,
  p_default_region_template=>2379806844072063 + wwv_flow_api.g_id_offset,
  p_default_chart_template =>2378201702072061 + wwv_flow_api.g_id_offset,
  p_default_form_template  =>2378501950072061 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>2379806844072063 + wwv_flow_api.g_id_offset,
  p_default_tabform_template=>2379806844072063 + wwv_flow_api.g_id_offset,
  p_default_wizard_template=>2380631881072063 + wwv_flow_api.g_id_offset,
  p_default_menur_template=>2377818975072059 + wwv_flow_api.g_id_offset,
  p_default_listr_template=>2378100843072061 + wwv_flow_api.g_id_offset,
  p_default_irr_template=>2378902254072061 + wwv_flow_api.g_id_offset,
  p_default_report_template   =>2381516601072066 + wwv_flow_api.g_id_offset,
  p_default_label_template=>2384102926072069 + wwv_flow_api.g_id_offset,
  p_default_menu_template=>2385532337072070 + wwv_flow_api.g_id_offset,
  p_default_calendar_template=>2385701075072072 + wwv_flow_api.g_id_offset,
  p_default_list_template=>2383628420072067 + wwv_flow_api.g_id_offset,
  p_default_option_label=>2384201758072069 + wwv_flow_api.g_id_offset,
  ...
  p_default_required_label=>2384417179072069 + wwv_flow_api.g_id_offset);
end;
/
...
prompt  ...Language Maps for Application 555
--
...
prompt  ......authentication 2386419784072088
 
begin
 
wwv_flow_api.create_authentication (
  p_id => 2386419784072088 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ...data loading
--
--application/shared_components/data loading/tables/emp
 
begin
 
wwv_flow_api.create_load_table(
p_id                    =>2388914650083198+ wwv_flow_api.g_id_offset,
p_flow_id               => wwv_flow.g_flow_id,
p_name                  =>'EMP',
p_owner                 =>'#OWNER#',
p_table_name            =>'EMP',
...
wwv_flow_api.create_load_table(
p_id                    =>2448215398209532+ wwv_flow_api.g_id_offset,
p_flow_id               => wwv_flow.g_flow_id,
p_name                  =>'emp2',
p_owner                 =>'#OWNER#',
p_table_name            =>'EMP',
